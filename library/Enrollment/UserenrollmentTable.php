...
/**
 * Table widget to display a list of Userenrollments
 */
class UserenrollmentTable extends DataTable
{
    ...
    {
        $columns = [];
        foreach ((new Userenrollment())->getColumnDefinitions() as $column=>$options){
    ...
    protected function renderRow(Model $row)
    {
        ...
        if (Auth::getInstance()->hasPermission('enrollment/userenrollment/modify')) {
            $url = Url::fromPath('enrollment/userenrollment/edit', ['id' => $row->id]);
