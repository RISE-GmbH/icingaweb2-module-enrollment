    ...
    public function applyRestrictions(Query $query)
    {
        ...
        foreach ($queries as $query) {
            ...
            foreach ($this->getAuth()->getUser()->getRoles() as $role) {
                ...
                if (($restriction = $role->getRestrictions('enrollment/filter/activitylogs'))) {
                    $roleFilter->add($this->parseRestriction($restriction, 'enrollment/filter/activitylogs'));
                }
