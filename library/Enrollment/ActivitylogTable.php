...
/**
 * Table widget to display a list of Activitylogs
 */
class ActivitylogTable extends DataTable
{
    ...
    {
        $columns = [];
        foreach ((new Activitylog())->getColumnDefinitions() as $column=>$options){
    ...
    protected function renderRow(Model $row)
    {
        ...
        if (Auth::getInstance()->hasPermission('enrollment/activitylog/modify')) {
            $url = Url::fromPath('enrollment/activitylog/edit', ['id' => $row->id]);
