...
class ActivitylogForm extends CompatForm
{
     ...
     *
     * @return \Icinga\Module\Enrollment\Forms\ActivitylogForm
     */
    ...
    /**
     * Create a new form instance with the given activitylog id
     *
     * @param $id
     *
     * @return \Icinga\Module\Enrollment\Forms\ActivitylogForm
    ...
    public function getSubmitButtonLabel(): string
    {
        ...
        return $this->id === null ? $this->translate('Create Activitylog') : $this->translate('Update Activitylog');
    }
    protected function assemble()
    {

        $columns = (new Activitylog())->getColumnDefinitions();
        ...
        if ($this->id !== null) {
            ...
            $removeButton = $this->createElement('submit', 'remove', [
                'label'          => $this->translate('Remove Activitylog'),
                'class'          => 'btn-remove',
                'formnovalidate' => true
            ]);
    ...
    public function onSuccess()
    {
        ...
        if ($this->id === null) {
            ...
            $model = Activitylog::on(Database::get())->filter(Filter::equal('id', $this->id))->first();
